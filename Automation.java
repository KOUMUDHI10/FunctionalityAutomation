...
int length=driver.findElements(By.cssSelector("ul.react-
autosuggest_suggestions-list>li")).size();
...
((WebElement)driver.findElements(By.cssSelector("ul.react-autosuggest_suggestions-list>li.div>div>p.searchedResult.font14.darkText>span")).get(i)).click();
